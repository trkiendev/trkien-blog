                              ...
                              <div>
                                    ...
                                    <ul className="bullet-list">
                                          <li>
                                                ...
                                                <br />
                                                Khi toàn bộ quy tắc nghiệp vụ được đặt trong domain entity (ví dụ ExpensePayment, BudgetPlan), mỗi quy tắc chỉ tồn tại một nơi duy nhất. 
                                                <br />
                                          ...
                                          <li>
                                               ...
                                               <br />
                                               Toàn bộ chi tiết, thao tác nghiệp vụ sẽ được diễn giải bên trong class domain (AdvancePayment, WaitingSettlement, BudgetExceeded…) thì source code trở thành tài liệu nghiệp vụ sống, 
                                          ...
                                          <li>
                                                ...
                                                <br />
                                                Trong các hệ thống áp dụng DDD, 1 nghiệp vụ lớn có thể chia thành nhiều nghiệp vụ nhỏ: bounded context để giảm độ phức tạp (giống với ý tưởng chia để trị: divide & conquere)
